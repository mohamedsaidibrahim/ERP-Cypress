...
describe("Warehouse(Add)", () => {
  beforeEach(() => {
    cy.visit(InventoryData.WarehouseUrl);
  });

  it("1.Verify Adding new Warehouse(All fields are filled)", () => {
    Warehouse.landing();
    cy.wait(1500);
    ...
    Warehouse.selectWarehouseTypeTxt(InventoryData.vanSalesType);
    ...
    cy.wait(750);
    Warehouse.setGlAccountId("add");
    Warehouse.setCashSalesAccountId("add");
    Warehouse.setCreditSalesAccountId("add");
    Warehouse.setSalesReturnAccountId("add");
    Warehouse.setPurchaseAccountId("add");
    Warehouse.setSalesCostAccountId("add");
    Warehouse.setDiscountAccountId("add");
    Warehouse.setEvaluationAccountId("add");
    Warehouse.setAdjustmentAccountId("add");
    Warehouse.setGoodsInTransitAccountId("add");
    // Address Tab
    cy.logMsg("(Add) Address Tab");
    Warehouse.switchToAddressTab();
    Warehouse.selectCountryCode();
    Warehouse.inputPhone();
    Warehouse.setCity("add");
  ...
  it("2.Verify Requird Validation", () => {
    ...
    // fill All The Required Components in the Quick Dialog
    cy.logMsg("fill All The Required Components in the Quick Dialog");
    Warehouse.selectWarehouseTypeTxt(InventoryData.itemCategoryNameEn);
    Warehouse.selectBranchWarehousesTxt();
    Warehouse.setName(InventoryData.itemName);
    Warehouse.clickSaveContinueButton();
  ...
  it("3.Verify Labels", () => {
    ...
    Warehouse.selectWarehouseTypeTxt(InventoryData.physicalType);
    Warehouse.selectBranchWarehousesTxt();
    Warehouse.setName(InventoryData.nameEn);
    Warehouse.clickSaveContinueButton();
    // Headers
